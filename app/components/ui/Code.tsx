...
import darkTheme from 'prism-react-renderer/dist/index'
import lightTheme from 'prism-react-renderer/dist/index'
...
const Code: FC<CodeProps> = ({
  ...
  return (
    <Highlight code={text} language={language} theme={undefined}>
